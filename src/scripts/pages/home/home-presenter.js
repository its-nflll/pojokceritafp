...
const HomePresenter = {
  ...
  initForm() {
    ...
    takePhotoBtn?.addEventListener('click', async () => {
      ...
      try {
        const blob = await new Promise(resolve => cameraCanvas.toBlob(resolve, 'image/jpeg'));
        ...
        message.textContent = 'Gagal mengambil foto';
      }
    });
    ...
    storyForm?.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        } else if (previewPhoto.style.display !== 'none') {
